...
public abstract class CameraActivity extends AppCompatActivity
    ...
    public void onPreviewFrame(final byte[] bytes, final Camera camera) {
        ...
        try {
            // Inisialisasi bitmap penyimpanan satu kali saat resolusinya diketahui
            if (rgbBytes == null) {
    ...
    public void onImageAvailable(final ImageReader reader) {
        // Menunggu sampai memiliki beberapa ukuran dari onPreviewSizeChosen
    ...
    protected void fillBytes(final Plane[] planes, final byte[][] yuvBytes) {
        // Karena langkah baris variabel, tidak mungkin untuk mengetahuinya
        // memajukan dimensi aktual yang diperlukan dari bidang yuv.
